...
export const validateRoadmapCreate = [
  ...
  body('nodes.*.description').isString().withMessage('Description is required'),
  body('nodes.*.resources.*.resourceLabel').isString().withMessage('Resource label is required'),
  body('nodes.*.rosources.*.resourceType').isString().withMessage('Resource type is required'),
  body('nodes.*.resources.*.resourceURL').isString().withMessage('Resource URL is required'),
